...
from nlp.b_gen_vocabulary import read_data_nmt, text_preprocess, text_split
...
if __name__ == "__main__":
    ...
    path_txt = r'../c2e/test.txt'
    vocab_path_en = '../c2e/vocab_en.npy'
    vocab_path_fra = '../c2e/vocab_cmn.npy'

    test_set = NMTDataset(path_txt, vocab_path_en, vocab_path_fra, max_len=64)
